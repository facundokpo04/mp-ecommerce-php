<?php
    ...
    $preference->external_reference = "facundokpo04@gmail.com";

    $preference->back_urls = array(
        "success" => "https://facundokpo04-mp-commerce-php.herokuapp.com/response.php?status=success",
        "failure" => "https://facundokpo04-mp-commerce-php.herokuapp.com/response.php?status=failure",
        "pending" => "https://facundokpo04-mp-commerce-php.herokuapp.com//response.php?status=pending"
    );
